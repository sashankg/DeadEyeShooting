//
//  FGAirTournamentViewController.m
//  DeadEyeShootingios
//
...
@interface FGTopAirTournamentViewController ()

@end

@implementation FGTopAirTournamentViewController
...
{
    [super viewDidLoad];
    arr_top5Score = [((AppDelegate *)[UIApplication sharedApplication].delegate) getTop5Score:@"TopAirTournament"];
