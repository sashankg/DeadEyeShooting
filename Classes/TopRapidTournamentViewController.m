//
//  TopRapidTournamentViewController.m
//  DeadEyeShootingios
//
...
@interface TopRapidTournamentViewController ()

@end

@implementation TopRapidTournamentViewController
...
{
    [super viewDidLoad];
    arr_top5Score = [((AppDelegate *)[UIApplication sharedApplication].delegate) getTop5Score:@"TopRapidTournament"];
